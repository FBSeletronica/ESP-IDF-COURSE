/******************************************************************************
*  Bluetooth LE GATT Server Example 2
*  This examples show how to add a Battery Service to the GATT server
*  It also shows how to notify connected clients about the battery level
*  changes.
* 
...
static void battery_task(void *param) {
    ...
    while(1)
    {
        ...
        /* Notify connected devices about the battery level */
...
void app_main(void) {
    ...
    xTaskCreate(battery_task,"Battery",4*1024, NULL, 5, NULL);
    return;
}
