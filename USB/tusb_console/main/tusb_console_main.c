...
void app_main(void)
{
    ...
    const tinyusb_config_t tusb_cfg = {
        .device_descriptor = NULL, //Will use the one defined in menuconfig
        .string_descriptor = NULL, //Will use the one defined in menuconfig
    ...
    while (1) {
        ...
        vTaskDelay(1000 / portTICK_PERIOD_MS);
        fprintf(stdout, "example: print -> stdout\n");
        vTaskDelay(1000 / portTICK_PEwRIOD_MS);
        fprintf(stderr, "example: print -> stderr\n");
        vTaskDelay(1000 / portTICK_PERIOD_MS);
